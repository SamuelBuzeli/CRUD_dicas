                ...
                <div class="container-fluid">
                    ...
                    <div class="logo">
                        ...
                        <a href="index.html" class="logo">
                            <span class="logo-large"></i>HOME</span>
                        </a>
                    </div>
                    <!-- End Logo container-->
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="../../../assets/site/img/door.png" alt="logo-supera" heigth="100">  <span class="ml-1 pro-user-name"><i class="mdi mdi-chevron-down"></i> </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">

                                    <!-- item-->
                                    <a href="{{ route('admin.cadastro') }}" class="dropdown-item notify-item">
                                        <i class="fi-head"></i> <span>Cadastre-se</span>
                                    </a>

                                    <!-- item-->
                                    <a href=" {{ route('admin.login') }} " class="dropdown-item notify-item">
                                        <i class="fi-arrow-right"></i> <span>Login</span>
                                    </a>
